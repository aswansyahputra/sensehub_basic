      ...
      column(
        ...
        wellPanel(
          ...
          conditionalPanel(
            ...
            ns = ns,
            helpText(tags$small("Contoh menggunakan data Flash Profiling untuk produk jus. Pengaturan parameter adalah sebagai berikut: Panelis = 'Panelist', Atribut sensoris = 'Attribute', Sampel = 'Juice', Ranking sampel = 'Rank'."))
          ),
          conditionalPanel(
...
metodeFp <- function(input, output, session) {
  ns <- session$ns
